...
/**
 * Parses instrument settings for the {@link InstrumentModel#THERMO_ORBITRAP_FUSION} instrument.
 */
public class FusionReader extends DefaultInstrumentReader {

    public FusionReader(String encoding) {
        super(encoding);
    }
