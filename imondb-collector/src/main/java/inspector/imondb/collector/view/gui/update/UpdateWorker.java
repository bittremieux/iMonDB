package inspector.imondb.collector.view.gui.update;
...
public class UpdateWorker extends SwingWorker<String, Void> {
    ...
    private JPanel createUpdatePanel(String version) {
        ...
        linkPanel.add(new inspector.imondb.collector.view.gui.about.JLabelLink("website", "https://bitbucket.org/proteinspector/imondb").getLabel());
